...
namespace ChristWare.Core
{
    public static class Signatures
    {
        ...
        [Pattern("engine.dll", "B8 ? ? ? ? C3 05 ? ? ? ? C3", 0, false, new int[] { 1 })]
        public static readonly Int32 dwClientState_MapDirectory; //change
        ...
        [Pattern("engine.dll", "F3 0F 11 86 ? ? ? ? F3 0F 10 44 24 ? F3 0F 11 86", 0, false, new int[] { 4 })]
        ...
        [Pattern("client.dll", "BB ? ? ? ? 83 FF 01 0F 8C ? ? ? ? 3B F8", 0, true, new int[] { 1 })]
        public static readonly Int32 dwEntityList;
        [Pattern("client.dll", "89 0D ? ? ? ? 8B 0D ? ? ? ? 8B F2 8B C1 83 CE 04", 0, true, new int[] { 2 })]
        public static readonly Int32 dwForceAttack;
        [Pattern("client.dll", "89 0D ? ? ? ? 8B 0D ? ? ? ? 8B F2 8B C1 83 CE 04", 12, true, new int[] { 2 })]
        public static readonly Int32 dwForceAttack2;
        [Pattern("client.dll", "55 8B EC 51 53 8A 5D 08", 0, true, new int[] { 287 })]
        public static readonly Int32 dwForceBackward;
        [Pattern("client.dll", "55 8B EC 51 53 8A 5D 08", 0, true, new int[] { 245 })]
        public static readonly Int32 dwForceForward;
        [Pattern("client.dll", "8B 0D ? ? ? ? 8B D6 8B C1 83 CA 02", 0, true, new int[] { 2 })]
        public static readonly Int32 dwForceJump;
        [Pattern("client.dll", "55 8B EC 51 53 8A 5D 08", 0, true, new int[] { 465 })]
        public static readonly Int32 dwForceLeft;
        [Pattern("client.dll", "55 8B EC 51 53 8A 5D 08", 0, true, new int[] { 512 })]
        public static readonly Int32 dwForceRight;
        [Pattern("engine.dll", "68 ? ? ? ? 8D 85 ? ? ? ? 50 68 ? ? ? ? 68", 0, true, new int[] { 1 })]
        public static readonly Int32 dwGameDir; //change
        [Pattern("client.dll", "A1 ? ? ? ? 85 C0 0F 84 ? ? ? ? 80 B8 ? ? ? ? ? 74 7A", 0, true, new int[] { 1 })]
        public static readonly Int32 dwGameRulesProxy;
        [Pattern("client.dll", "A1 ? ? ? ? C3 CC CC CC CC CC CC CC CC CC CC A1 ? ? ? ? B9", 0, true, new int[] { 1, 0 })]
        ...
        [Pattern("client.dll", "A1 ? ? ? ? A8 01 75 4B", 4, true, new int[] { 1 })]
        public static readonly Int32 dwGlowObjectManager;
        [Pattern("client.dll", "B9 ? ? ? ? F3 0F 11 04 24 FF 50 10", 0, true, new int[] { 1 })]
        public static readonly Int32 dwInput;
        [Pattern("client.dll", "8B 35 ? ? ? ? 57 85 F6 74 ? 8B 7D 08 8B 4E 04 8B C7 8A 11 3A 10", 0, true, new int[] { })]
        public static readonly Int32 dwInterfaceLinkList;
        [Pattern("client.dll", "8D 34 85 ? ? ? ? 89 15 ? ? ? ? 8B 41 08 8B 48 04 83 F9 FF", 4, true, new int[] { 3 })]
        public static readonly Int32 dwLocalPlayer;
        [Pattern("client.dll", "B9 ? ? ? ? FF 50 34 85 C0 75 10", 48, true, new int[] { 1 })]
        public static readonly Int32 dwMouseEnable;
        [Pattern("client.dll", "B9 ? ? ? ? FF 50 34 85 C0 75 10", 0, true, new int[] { 1 })]
        public static readonly Int32 dwMouseEnablePtr;
        [Pattern("client.dll", "8B 3D ? ? ? ? 85 FF 0F 84 ? ? ? ? 81 C7", 0, true, new int[] { 2 })]
        public static readonly Int32 dwPlayerResource;
        [Pattern("client.dll", "A1 ? ? ? ? 8B 0C B0 8B 01 FF 50 ? 46 3B 35 ? ? ? ? 7C EA 8B 0D", 0, true, new int[] { 1 })]
        public static readonly Int32 dwRadarBase;
        [Pattern("client.dll", "81 F9 ? ? ? ? 75 1D F3 0F 10 05 ? ? ? ? F3 0F 11 44 24 ? 8B 44 24 0C 35 ? ? ? ? 89 44 24 0C", 44, true, new int[] { 2 })]
        public static readonly Int32 dwSensitivity;
        [Pattern("client.dll", "81 F9 ? ? ? ? 75 1D F3 0F 10 05 ? ? ? ? F3 0F 11 44 24 ? 8B 44 24 0C 35 ? ? ? ? 89 44 24 0C", 0, true, new int[] { 2 })]
        ...
        [Pattern("client.dll", "0F 10 05 ? ? ? ? 8D 85 ? ? ? ? B9", 176, true, new int[] { 3 })]
        public static readonly Int32 dwViewMatrix;
        [Pattern("client.dll", "B9 ? ? ? ? 6A 00 FF 50 08 C3", 0, true, new int[] { 1 })]
        public static readonly Int32 dwWeaponTable;
        [Pattern("client.dll", "39 86 ? ? ? ? 74 06 89 86 ? ? ? ? 8B 86", 0, false, new int[] { 2 })]
        public static readonly Int32 dwWeaponTableIndex;
        [Pattern("client.dll", "81 F9 ? ? ? ? 75 16 F3 0F 10 05 ? ? ? ? F3 0F 11 45 ? 81 75 ? ? ? ? ? EB 0A 8B 01 8B 40 30 FF D0 D9 5D 0C 8B 55 08", 0, true, new int[] { 2 })]
        public static readonly Int32 dwYawPtr;
        [Pattern("client.dll", "81 F9 ? ? ? ? 75 1A F3 0F 10 05 ? ? ? ? F3 0F 11 45 ? 8B 45 F4 35 ? ? ? ? 89 45 FC EB 0A 8B 01 8B 40 30 FF D0 D9 5D FC A1", 0, true, new int[] { 2 })]
        ...
        [Pattern("client.dll", "8B B6 ? ? ? ? 85 F6 74 05 83 3E 00 75 02 33 F6 F3 0F 10 44 24", 0, false, new int[] { 2 })]
        public static readonly Int32 m_pStudioHdr;
        [Pattern("client.dll", "81 F9 ? ? ? ? 75 16 F3 0F 10 05 ? ? ? ? F3 0F 11 45 ? 81 75 ? ? ? ? ? EB 0A 8B 01 8B 40 30 FF D0 D9 5D 0C 8B 55 08", 0, true, new int[] { 2 })]
        public static readonly Int32 m_yawClassPtr;
        [Pattern("client.dll", "A1 ? ? ? ? 89 74 24 28", 0, true, new int[] { 1 })]
        public static readonly Int32 m_pitchClassPtr;
        [Pattern("client.dll", "8A 81 ? ? ? ? C3 32 C0", 8, false, new int[] { 2 })]
        ...
        [Pattern("client.dll", "55 8B EC 83 E4 F8 83 EC 64 53 56 57 8B F1 E8", 0, true, new int[] { })]
        public static readonly Int32 set_abs_angles;
        [Pattern("client.dll", "55 8B EC 83 E4 F8 51 53 56 57 8B F1 E8", 0, true, new int[] { })]
        public static readonly Int32 set_abs_origin;
        [Pattern("client.dll", "56 8B F1 85 F6 74 31", 0, true, new int[] { })]
        public static readonly Int32 is_c4_owner;
        [Pattern("client.dll", "74 07 8B CB E8 ? ? ? ? 83 C7 10", 0, true, new int[] { })]
        public static readonly Int32 force_update_spectator_glow;
        [Pattern("client.dll", "44 54 5F 54 45 57 6F 72 6C 64 44 65 63 61 6C", 0, false, new int[] { })]
